...
export default function RegisterPage() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      // api helper JSON return karta hai; res.ok/res.json ki zarurat nahi
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-[#020617] px-4 py-10 transition-colors">
      <div className="w-full max-w-md bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl shadow-2xl p-8 backdrop-blur-xl">
        <h2 className="text-3xl font-black text-center text-gray-900 dark:text-white tracking-tight">
          Join StaySmart
        </h2>
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-2 mb-8 uppercase tracking-widest font-bold">
          Register Account
        </p>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div className="relative group">
            ...
            <input
              ...
              value={name}
              onChange={(e) =>
                updateField("name", e.target.value, setName)
              }
          ...
          <div className="relative group">
            ...
            <input
              ...
              value={email}
              onChange={(e) =>
                updateField("email", e.target.value, setEmail)
              }
          ...
          <div className="relative group">
            ...
            <input
              ...
              value={mobile}
              onChange={(e) =>
                updateField("mobile", e.target.value, setMobile)
              }
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-bold transition-all shadow-lg shadow-blue-600/30 transform hover:scale-[1.02] active:scale-95"
          >
            Register Now
          </button>
        </form>
